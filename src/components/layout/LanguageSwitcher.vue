<template>
  <div class="relative">
    ...
    >
      <div class="inline-block p-2 bg-color-white"><span class="text-sm">{{ currentLanguage }}</span>
      <svg 
    ...
    >
      <div class="py-1">
        ...
        >
          <div class="inline-block p-2 bg-color-white"><span class="mr-2">{{ lang.flag }}</span></div>
          {{ lang.name }}
        </button>
      </div>
    </div>
